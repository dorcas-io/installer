module.exports = function(grunt) {
  ...
  grunt.file.write(
    "sass/theme.scss",
    '@import "themes/' + grunt.option("Layout") + '/theme";'
  );
    ...
    sass: {
      main: {
        ...
        files: {
          ...
          "css/layouts/style-horizontal.css":
      ...
      dist: {
        ...
        files: {
          ["css/themes/" +
          myLayout +
          "/materialize.min.css"]: "sass/materialize.scss",
          ["css/themes/" + myLayout + "/style.min.css"]: "sass/style.scss",
          "css/layouts/style-fullscreen.min.css":
            "sass/theme-components/layouts/style-fullscreen.scss",
          "css/layouts/style-horizontal.min.css":
            "sass/theme-components/layouts/style-horizontal.scss",
