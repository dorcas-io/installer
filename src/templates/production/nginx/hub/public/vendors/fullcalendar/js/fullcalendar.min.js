...
(function(t) {
  ...
  function i(e) {
    ...
    return (
      t.each(e, function(e, r) {
        "views" != e &&
          (t.isPlainObject(r) &&
          !/(time|duration|interval)$/i.test(e) &&
          -1 == t.inArray(e, Pe)
            ? ((n = null),
        ...
        : ((s = !1),
          ...
          s
            ...
            : r &&
              (o
                ? (a._ambigZone = !0)
                : c && (a.utcOffset ? a.utcOffset(u) : a.zone(u)))),
      (a._fullCalendar = !0),
      a
    );
  }
  ...
  function Re(n, i) {
    ...
    function s() {
      (U = B.theme ? "ui" : "fc"),
        ...
        Z && n.prepend(Z),
        a(B.defaultView),
        B.handleWindowResize &&
          ((K = $(h, B.windowResizeDelay)), t(window).resize(K));
    }
    function o() {
      q && q.removeElement(),
        W.destroy(),
    ...
    function a(e) {
      ie++,
        q &&
          e &&
          q.type !== e &&
          (W.deactivateButton(q.type),
          G(),
          q.removeElement(),
          (q = N.view = null)),
        !q &&
          e &&
          ((q = N.view = ne[e] || (ne[e] = N.instantiateView(e))),
          q.setElement(
            t("<div class='fc-view fc-" + e + "-view' />").appendTo(j)
          ),
          W.activateButton(e)),
        q &&
          ((Q = q.massageCurrentDate(Q)),
          (q.isDisplayed && Q.isWithin(q.intervalStart, q.intervalEnd)) ||
            (l() && (G(), q.display(Q), L(), E(), S(), m()))),
        L(),
        ie--;
    }
    function u(t) {
    ...
    function d() {
      X =
        "number" == typeof B.contentHeight
          ? B.contentHeight
          : "number" == typeof B.height
          ? B.height - (Z ? Z.outerHeight(!0) : 0)
          : Math.round(j.width() / Math.max(B.aspectRatio, 0.5));
    }
    function h(t) {
      !ie &&
        t.target === window &&
    ...
    function S() {
      var t = N.getNow();
      t.isWithin(q.intervalStart, q.intervalEnd)
    ...
    function b(t, e) {
      (t = N.moment(t)),
        (e = e
          ? N.moment(e)
          : t.hasTime()
          ? t.clone().add(N.defaultTimedEventDuration)
          : t.clone().add(N.defaultAllDayEventDuration)),
        q.select({ start: t, end: e });
    }
    function D() {
      q && q.unselect();
    }
    ...
    var Y = _(Me(B.lang));
    if (
      (B.monthNames && (Y._months = B.monthNames),
    ...
    (Y._fullCalendar_weekCalc = (function(t) {
      ...
      (N.moment = function() {
        ...
        return (
          "local" === B.timezone
            ...
            : (t =
                "UTC" === B.timezone
                  ? Le.moment.utc.apply(null, arguments)
      ...
      (N.getDefaultEventEnd = function(t, e) {
        ...
        return (
          t
            ? n.stripTime().add(N.defaultAllDayEventDuration)
  ...
  function ze(n) {
    function i(t, e) {
      return (
        !W ||
        t.clone().stripZone() < W.clone().stripZone() ||
    ...
    function o(e, i) {
      ...
      for (r = 0; l.length > r; r++) {
        if (
          ((s = l[r].call(I, e, W.clone(), Z.clone(), n.timezone, i)), s === !0)
        )
          return;
    ...
    function p(t, e) {
      ...
      if (s) {
        for (n = T(s), i = 0; n.length > i; i++)
          (r = n[i]),
            r.source || (e && ($.events.push(r), (r.source = $)), te.push(r));
        return q(te), n;
      }
      return [];
    }
    ...
    function E(i, r) {
      ...
      if (
        ...
        o && ((o = I.moment(o)), o.isValid() || (o = null)),
          (l = i.allDay),
          void 0 === l &&
            (l = B(r ? r.allDayDefault : void 0, n.allDayDefault)),
          S(s, o, l, a);
      }
      return a;
    }
        ...
        t.each(e, function(e, u) {
          ...
          (c = {
            ...
            n
              ...
              : s &&
                !d.end &&
                (d.end = I.getDefaultEventEnd(d.allDay, d.start)),
    ...
    function F(e) {
      var i,
        ...
        o = I.getView();
      return (
        r && (i = t.extend({}, s, "object" == typeof r ? r : {})),
        i
  ...
  var Le = (t.fullCalendar = { version: "2.3.1" }),
    _e = (Le.views = {});
  ...
  (Le.moment = function() {
    ...
    (je.week = je.weeks = function(t) {
      ...
      return null == t && "function" == typeof e
        ? e(this)
        : "ISO" === e
        ? Ue.isoWeek.apply(this, arguments)
        : Ue.week.apply(this, arguments);
    }),
    (je.time = function(t) {
    ...
    (je.format = function() {
      return this._fullCalendar && arguments[0]
        ...
        : Ue.format.apply(this, arguments);
    }),
    (je.toISOString = function() {
      return this._ambigTime
        ...
        : this._ambigZone
        ? te(this, "YYYY-MM-DD[T]HH:mm:ss")
        : Ue.toISOString.apply(this, arguments);
    }),
    ...
    (je.isSame = function(t, e) {
      ...
      return this._fullCalendar
        ? e
          ? ((n = K([this, t], !0)), Ue.isSame.call(n[0], n[1], e))
          : ((t = Le.moment.parseZone(t)),
            Ue.isSame.call(this, t) &&
              Boolean(this._ambigTime) === Boolean(t._ambigTime) &&
              Boolean(this._ambigZone) === Boolean(t._ambigZone))
        : Ue.isSame.apply(this, arguments);
    }),
    ...
    tn = (Le.DragListener = ue.extend({
      ...
      startListening: function(e) {
        ...
        this.isListening ||
          ...
          t(document)
            .on("mousemove", (this.mousemoveProxy = q(this, "mousemove")))
            .on("mouseup", (this.mouseupProxy = q(this, "mouseup")))
      ...
      stopDrag: function(t) {
        this.isDragging &&
          (this.stopScrolling(), this.dragStop(t), (this.isDragging = !1));
      },
      dragStop: function(t) {
        var e = this;
    ...
    en = tn.extend({
          ...
          t
            ? ((n = { left: t.pageX, top: t.pageY }),
              ...
              r &&
                ...
                (this.origCell && (e = b(this.origCell, e) || e), (i = C(e))),
              (this.coordAdjust = T(i, n)))
      ...
      drag: function(t, e, n) {
        ...
        tn.prototype.drag.apply(this, arguments),
          ...
          ce(i, this.cell) ||
            (this.cell && this.cellOut(), i && this.cellOver(i));
      },
      dragStop: function() {
    ...
    nn = ue.extend({
      ...
      start: function(e) {
        this.isFollowing ||
          ...
          t(document).on(
            "mousemove",
            (this.mousemoveProxy = q(this, "mousemove"))
          ));
      },
      stop: function(e, n) {
        function i() {
    ...
    sn = (Le.Grid = rn.extend({
      ...
      setRange: function(t) {
        ...
        (this.start = t.start.clone()),
          ...
          this.updateCells(),
          (this.colHeadFormat =
            i.opt("columnFormat") || this.computeColHeadFormat()),
          (this.eventTimeFormat =
            i.opt("eventTimeFormat") ||
            i.opt("timeFormat") ||
      ...
      computeRowCoords: function() {
        ...
        for (t = 0; this.rowCnt > t; t++)
          (e = this.getRowEl(t)),
            (n = e.offset().top),
            i.push({ top: n, bottom: n + e.outerHeight() });
        return i;
      },
      computeColCoords: function() {
        ...
        for (t = 0; this.colCnt > t; t++)
          (e = this.getColEl(t)),
            (n = e.offset().left),
            i.push({ left: n, right: n + e.outerWidth() });
        return i;
      },
      setElement: function(e) {
        ...
        (this.el = e),
          e.on("mousedown", function(e) {
            t(e.target).is(".fc-event-container *, .fc-more") ||
              t(e.target).closest(".fc-popover").length ||
              n.dayMousedown(e);
          }),
      ...
      return (
        t.each(i, function(t, e) {
          e.length &&
            r.push.apply(
              r,
              he(e[0]) ? n.eventsToInverseRanges(e) : n.eventsToNormalRanges(e)
            );
        }),
        r
      );
      ...
      for (
        ...
        (r = i * f),
          ...
          u >= a &&
            ...
            (a -= r),
            (u -= r),
            (c = { row: i, isStart: o, isEnd: l }),
            d
              ? ((c.leftCol = f - u - 1), (c.rightCol = f - a - 1))
              : ((c.leftCol = a), (c.rightCol = u)),
            g.push(c));
      return g;
    },
  ...
  on.mixin({
    ...
    getEventSegs: function() {
      return sn.prototype.getEventSegs
        .call(this)
      ...
      for (
        ...
        (t = this.start.clone().time(a)),
          ...
          (i =
            ...
            (l && n
              ? ""
              : "<span>" + Y(t.format(this.axisFormat)) + "</span>") +
            "</td>"),
          (o +=
            "<tr " +
            (n ? 'class="fc-minor"' : "") +
      ...
      if (n.length) {
        for (
          ...
          if (((a = r[l]), (u = t("<td/>").appendTo(o)), a.length))
            for (
              c = t('<div class="fc-' + i + '-container"/>').appendTo(u),
  ...
  ln.mixin({
    ...
    renderSegTable: function(e) {
      ...
      for (
        ...
        for (
          o = n[s], Ee(o), l = t('<div class="fc-event-container"/>'), i = 0;
          o.length > i;
          i++
        )
          (r = o[i]),
        ...
        '<a class="' +
          ...
          (n
            ? '<div class="fc-time" data-start="' +
              ...
              "</div>"
            : "") +
          (o.title ? '<div class="fc-title">' + Y(o.title) + "</div>" : "") +
          "</div>" +
          '<div class="fc-bg"/>' +
  ...
  var an = (Le.View = ue.extend({
      ...
      computeRange: function(t) {
        ...
        return (
          /year|month|week|day/.test(i)
            ...
            : (r.hasTime() || (r = this.calendar.rezoneDate(r)),
      ...
      massageCurrentDate: function(t, e) {
        return (
          1 >= this.intervalDuration.as("days") &&
            this.isHiddenDay(t) &&
      ...
      removeElement: function() {
        this.clear(),
          this.isSkeletonRendered &&
            (this.destroySkeleton(), (this.isSkeletonRendered = !1)),
    ...
    un = (Le.Calendar = Le.CalendarBase = ue.extend({
      ...
      buildViewSpec: function(t) {
        ...
        return i
          ? ((a = { class: i, type: t }),
            o && ((o = e.duration(o)), o.valueOf() || (o = null)),
            o &&
              ((a.duration = o),
              (l = M(o)),
              1 === o.as(l) && ((a.singleUnit = l), d.unshift(u[l] || {}))),
  ...
  (un.defaults = {
    ...
    (un.englishDefaults = { dayPopoverFormat: "dddd, MMMM D" }),
    (un.rtlDefaults = {
  ...
  var mn = (_e.basic = an.extend({
      ...
      numberIntroHtml: function(t) {
        return this.weekNumbersVisible
          ? '<td class="fc-week-number" ' +
              ...
              ">" +
              "<span>" +
              this.dayGrid.getCell(t, 0).start.format("w") +
              "</span>" +
              "</td>"
          : void 0;
      },
      ...
      updateWidth: function() {
        this.weekNumbersVisible &&
          (this.weekNumberWidth = c(this.el.find(".fc-week-number")));
      },
      setHeight: function(t, e) {
        ...
        h(this.scrollerEl),
          ...
          !e &&
            d(this.scrollerEl, n) &&
            (r(this.headRowEl, v(this.scrollerEl)),
            (n = this.computeScrollerHeight(t)),
  ...
  (vn.duration = { months: 1 }),
    (vn.defaults = { fixedWeekCount: !0 }),
    (_e.basicWeek = { type: "basic", duration: { weeks: 1 } }),
      ...
      setHeight: function(t, e) {
        ...
        null === this.bottomRuleHeight &&
          ...
          e ||
            ...
            d(this.scrollerEl, i)
              ? (r(this.noScrollRowEls, v(this.scrollerEl)),
                (i = this.computeScrollerHeight(t)),
  ...
  return (
    (En.defaults = yn),
    (_e.agendaWeek = { type: "agenda", duration: { weeks: 1 } }),
    (_e.agendaDay = { type: "agenda", duration: { days: 1 } }),
    Le
  );
});
