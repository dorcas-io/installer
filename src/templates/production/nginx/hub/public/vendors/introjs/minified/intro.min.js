(function(B, n) {
  ...
  function M(a) {
    ...
    if (this._options.steps)
      for (var e = 0, d = this._options.steps.length; e < d; e++) {
        var f = H(this._options.steps[e]);
        f.step = b.length + 1;
        "string" === typeof f.element &&
          (f.element = document.querySelector(f.element));
        if ("undefined" === typeof f.element || null == f.element) {
          var h = document.querySelector(".introjsFloatingElement");
          null == h &&
            ((h = document.createElement("div")),
            (h.className = "introjsFloatingElement"),
      ...
      for (f = d.length; e < f; e++) {
        var h = d[e],
          q = parseInt(h.getAttribute("data-step"), 10);
        0 < q &&
          (b[q - 1] = {
            element: h,
            ...
            position:
              h.getAttribute("data-position") || this._options.tooltipPosition
          });
      }
      e = q = 0;
      for (f = d.length; e < f; e++)
        if (((h = d[e]), null == h.getAttribute("data-step"))) {
          for (; "undefined" != typeof b[q]; ) q++;
          b[q] = {
            element: h,
            intro: h.getAttribute("data-intro"),
            step: q + 1,
  ...
  function H(a) {
    ...
    for (c in a)
      b[c] =
        "undefined" != typeof jQuery && a[c] instanceof jQuery ? a[c] : H(a[c]);
    return b;
  }
  function x() {
  ...
  function J(a, b, c, e) {
    ...
    if (this._introItems[this._currentStep]) {
      ...
      d =
        "string" === typeof d.tooltipClass
          ? d.tooltipClass
          : this._options.tooltipClass;
      b.className = ("introjs-tooltip " + d).replace(/^\s+|\s+$/g, "");
      h = this._introItems[this._currentStep].position;
      if (
        ("auto" == h || "auto" == this._options.tooltipPosition) &&
        "floating" != h
      ) {
        d = h;
        ...
        var q = v(b).height + 10,
          ...
          k = v(a),
          l = "floating";
        k.left + r > h.width || 0 > k.left + k.width / 2 - r
          ? (s(f, "bottom"), s(f, "top"))
          : (k.height + k.top + q > h.height && s(f, "bottom"),
            0 > k.top - q && s(f, "top"));
        k.width + k.left + r > h.width && s(f, "right");
        0 > k.left - r && s(f, "left");
        0 < f.length && (l = f[0]);
        d && "auto" != d && -1 < f.indexOf(d) && (l = d);
        h = l;
      }
      d = v(a);
      a = v(b);
      ...
      switch (h) {
        case "top":
          ...
          z(d, 15, a, f, b);
          b.style.bottom = d.height + 20 + "px";
          break;
        case "right":
          b.style.left = d.width + 20 + "px";
          d.top + a.height > f.height
            ? ((c.className = "introjs-arrow left-bottom"),
              (b.style.top = "-" + (a.height - d.height - 20) + "px"))
        ...
        case "floating":
          ...
          "undefined" != typeof e &&
            null != e &&
            ((e.style.left = "-" + (a.width / 2 + 18) + "px"),
            (e.style.top = "-" + (a.height / 2 + 18) + "px"));
          break;
        case "bottom-right-aligned":
          c.className = "introjs-arrow top-right";
          K(d, 0, a, b);
          b.style.top = d.height + 20 + "px";
          break;
        case "bottom-middle-aligned":
          c.className = "introjs-arrow top-middle";
          c = d.width / 2 - a.width / 2;
          K(d, c, a, b) && ((b.style.right = null), z(d, c, a, f, b));
          b.style.top = d.height + 20 + "px";
          break;
        default:
  ...
  function z(a, b, c, e, d) {
    if (a.left + b + c.width > e.width)
      return (d.style.left = e.width - c.width - a.left + "px"), !1;
    d.style.left = b + "px";
    return !0;
  }
  function K(a, b, c, e) {
    if (0 > a.left + a.width - b - c.width)
      return (e.style.left = -a.left + "px"), !1;
    e.style.right = b + "px";
    return !0;
  }
  function s(a, b) {
  ...
  function I(a) {
    ...
    var b = this,
      ...
      e = document.querySelector(".introjs-tooltipReferenceLayer"),
      d = "introjs-helperLayer";
    v(a.element);
    "string" === typeof a.highlightClass && (d += " " + a.highlightClass);
    "string" === typeof this._options.highlightClass &&
      (d += " " + this._options.highlightClass);
    if (null != c) {
      var f = e.querySelector(".introjs-helperNumberLayer"),
        h = e.querySelector(".introjs-tooltiptext"),
        q = e.querySelector(".introjs-arrow"),
        r = e.querySelector(".introjs-tooltip"),
        k = e.querySelector(".introjs-skipbutton"),
        l = e.querySelector(".introjs-prevbutton"),
        p = e.querySelector(".introjs-nextbutton");
      c.className = d;
      r.style.opacity = 0;
      ...
      b._lastShowElementTimer = setTimeout(function() {
        ...
        J.call(b, a.element, r, q, f);
        e.querySelector(".introjs-bullets li > a.active").className = "";
        e.querySelector(
          '.introjs-bullets li > a[data-stepnumber="' + a.step + '"]'
        ).className = "active";
        e.querySelector(".introjs-progress .introjs-progressbar").setAttribute(
          "style",
          "width:" + L.call(b) + "%;"
        );
        r.style.opacity = 1;
        f && (f.style.opacity = 1);
        -1 === p.tabIndex ? k.focus() : p.focus();
      }, 350);
    } else {
      ...
      for (
        ...
        d === a.step - 1 && (A.className = "active");
        A.href = "javascript:void(0);";
        A.innerHTML = "&nbsp;";
        A.setAttribute("data-stepnumber", this._introItems[d].step);
        z.appendChild(A);
        n.appendChild(z);
      }
      D.appendChild(n);
      ...
      d = document.createElement("div");
      d.className = "introjs-progressbar";
      d.setAttribute("style", "width:" + L.call(this) + "%;");
      E.appendChild(d);
      ...
      !0 == this._options.showStepNumbers &&
        ...
        (g.className = "introjs-helperNumberLayer"),
        (g.innerHTML = a.step),
        l.appendChild(g));
      m.appendChild(c);
      l.appendChild(m);
      ...
      p.innerHTML = this._options.nextLabel;
      ...
      u.appendChild(k);
      1 < this._introItems.length && (u.appendChild(l), u.appendChild(p));
      m.appendChild(u);
      J.call(b, a.element, m, c, g);
    }
    !0 === this._options.disableInteraction && O.call(b);
    l.removeAttribute("tabIndex");
    p.removeAttribute("tabIndex");
    0 == this._currentStep && 1 < this._introItems.length
      ? ((l.className = "introjs-button introjs-prevbutton introjs-disabled"),
        (l.tabIndex = "-1"),
        (p.className = "introjs-button introjs-nextbutton"),
        (k.innerHTML = this._options.skipLabel))
      : this._introItems.length - 1 == this._currentStep ||
        1 == this._introItems.length
      ? ((k.innerHTML = this._options.doneLabel),
        (l.className = "introjs-button introjs-prevbutton"),
        (p.className = "introjs-button introjs-nextbutton introjs-disabled"),
        (p.tabIndex = "-1"))
      : ((l.className = "introjs-button introjs-prevbutton"),
        (p.className = "introjs-button introjs-nextbutton"),
        (k.innerHTML = this._options.skipLabel));
    ...
    g = w(a.element, "position");
    "absolute" !== g &&
      "relative" !== g &&
      (a.element.className += " introjs-relativePosition");
    for (
      g = a.element.parentNode;
      null != g && "body" !== g.tagName.toLowerCase();

    ) {
      c = w(g, "z-index");
      m = parseFloat(w(g, "opacity"));
      u =
        w(g, "transform") ||
        w(g, "-webkit-transform") ||
        w(g, "-moz-transform") ||
        w(g, "-ms-transform") ||
        w(g, "-o-transform");
      if (/[0-9]+/.test(c) || 1 > m || ("none" !== u && void 0 !== u))
        g.className += " introjs-fixParent";
      g = g.parentNode;
    }
    P(a.element) ||
      !0 !== this._options.scrollToElement ||
      ((m = a.element.getBoundingClientRect()),
      (g = F().height),
      (c = m.bottom - (m.bottom - m.top)),
      (m = m.bottom - g),
      0 > c || a.element.clientHeight > g
        ? window.scrollBy(0, c - 30)
        : window.scrollBy(0, m + 100));
  ...
  function N(a) {
    ...
    b.onclick = function() {
      !0 == e._options.exitOnOverlayClick &&
        (void 0 != e._introExitCallback && e._introExitCallback.call(e),
        y.call(e, a));
    };
    setTimeout(function() {
      c += "opacity: " + e._options.overlayOpacity.toString() + ";";
      b.setAttribute("style", c);
    }, 10);
    return !0;
  }
