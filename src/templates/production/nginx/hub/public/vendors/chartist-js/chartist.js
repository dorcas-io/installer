(function(root, factory) {
  ...
  (function(window, document, Chartist) {
    ...
    Chartist.getBounds = function(
      ...
      bounds.min =
        Math.floor(bounds.low / Math.pow(10, bounds.oom)) *
        Math.pow(10, bounds.oom);
      bounds.max =
        Math.ceil(bounds.high / Math.pow(10, bounds.oom)) *
        Math.pow(10, bounds.oom);
    ...
    Chartist.createChartRect = function(svg, options, fallbackPadding) {
      ...
      return {
        ...
        y1: Math.max(
          h - normalizedPadding.bottom - xOffset,
          normalizedPadding.bottom
        ),
        x2: Math.max(
          w - normalizedPadding.right,
          normalizedPadding.right + yOffset
        ),
    ...
    Chartist.createLabel = function(
      ...
      positionalData[axis.units.pos] =
        projectedValue.pos + labelOffset[axis.units.pos];
    ...
    Chartist.createAxis = function(
      ...
      var axisOptions = options["axis" + axis.units.pos.toUpperCase()],
        projectedValues = data
          .map(axis.projectValue.bind(axis))
          .map(axis.transform),
      ...
      projectedValues.forEach(function(projectedValue, index) {
        ...
        if (axisOptions.showGrid) {
          Chartist.createGrid(
            ...
            axis,
            axis.gridOffset,
            chartRect[axis.counterUnits.len](),
            gridGroup,
            [options.classNames.grid, options.classNames[axis.units.dir]],
            eventEmitter
          );
        }
        ...
        if (axisOptions.showLabel) {
          Chartist.createLabel(
            ...
            axis.labelOffset,
            labelGroup,
            [options.classNames.label, options.classNames[axis.units.dir]],
            useForeignObject,
            eventEmitter
          );
        }
      ...
      if (this.container) {
        ...
        if (this.container.__chartist__) {
          if (this.container.__chartist__.initializeTimeoutId) {
            ...
            window.clearTimeout(
              this.container.__chartist__.initializeTimeoutId
            );
          } else {
  ...
  (function(window, document, Chartist) {
    ...
    function height() {
      return (
        ...
        Math.round(this._node.getBBox().height) ||
    ...
    function width() {
      return (
        ...
        Math.round(this._node.getBBox().width) ||
    ...
    Chartist.Svg.isSupported = function(feature) {
      return document.implementation.hasFeature(
        "www.http://w3.org/TR/SVG11/feature#" + feature,
        "1.1"
      );
    };
  ...
  (function(window, document, Chartist) {
    ...
    function LinearScaleAxis(
      ...
      Chartist.LinearScaleAxis.super.constructor.call(
        this,
        axisUnit,
        chartRect,
        transform,
    ...
    function projectValue(value) {
      return {
        pos:
          (this.axisLength * (value - this.bounds.min)) /
          (this.bounds.range + this.bounds.step),
        len: Chartist.projectLength(
          this.axisLength,
          this.bounds.step,
          this.bounds
        )
  ...
  (function(window, document, Chartist) {
    ...
    function StepAxis(axisUnit, chartRect, transform, labelOffset, options) {
      ...
      this.stepLength =
        this.axisLength / (options.stepCount - (options.stretch ? 1 : 0));
    }
  ...
  (function(window, document, Chartist) {
    ...
    function createChart(options) {
      var seriesGroups = [],
        normalizedData = Chartist.normalizeDataArray(
      ...
      var axisX = new Chartist.StepAxis(
        ...
        },
        {
          ...
          y:
            chartRect.y1 +
            options.axisX.labelOffset.y +
            (this.supportsForeignObject ? 5 : 20)
        },
        {
      ...
      var axisY = new Chartist.LinearScaleAxis(
        ...
        },
        {
          x:
            ...
            options.axisY.labelOffset.x +
            (this.supportsForeignObject ? -10 : 0),
          y:
            options.axisY.labelOffset.y + (this.supportsForeignObject ? -15 : 0)
        },
        {
          highLow: highLow,
      ...
      this.data.series.forEach(
        function(series, seriesIndex) {
          ...
          normalizedData[seriesIndex].forEach(
            function(value, valueIndex) {
              ...
              if (options.showPoint) {
                var point = seriesGroups[seriesIndex]
                  .elem(
                    "line",
                    {
                      x1: p.x,
          ...
          if (options.showLine || options.showArea) {
            var smoothing =
                typeof options.lineSmooth === "function"
                  ? options.lineSmooth
                  : options.lineSmooth
            ...
            if (options.showLine) {
              var line = seriesGroups[seriesIndex]
                .elem(
                  "path",
                  {
                    d: path.stringify()
            ...
            if (options.showArea) {
              ...
              var areaBase = Math.max(
                Math.min(options.areaBase, axisY.bounds.max),
                axisY.bounds.min
              );

              // We project the areaBase value into screen coordinates
              var areaBaseProjected =
                chartRect.y1 - axisY.projectValue(areaBase).pos;
              ...
              var area = seriesGroups[seriesIndex]
                .elem(
                  "path",
                  {
  ...
  (function(window, document, Chartist) {
    ...
    function createChart(options) {
      ...
      var valueAxis, labelAxis, axisX, axisY;
      ...
      if (options.horizontalBars) {
        labelAxis = axisY = new Chartist.StepAxis(
          ...
          },
          {
            x:
              ...
              (this.supportsForeignObject ? -10 : 0),
            y:
              options.axisY.labelOffset.y -
              chartRect.height() / this.data.labels.length
          },
          {
            stepCount: this.data.labels.length,
        ...
        valueAxis = axisY = new Chartist.LinearScaleAxis(
          ...
          },
          {
            ...
            y:
              options.axisY.labelOffset.y +
              (this.supportsForeignObject ? -15 : 0)
          },
          {
            highLow: highLow,
            scaleMinSpace: options.axisY.scaleMinSpace,
      ...
      var labelGroup = this.svg
        ...
        gridGroup = this.svg.elem("g").addClass(options.classNames.gridGroup),
        // Projected 0 point
        zeroPoint = options.horizontalBars
          ? chartRect.x1 + valueAxis.projectValue(0).pos
          : chartRect.y1 - valueAxis.projectValue(0).pos,
      ...
      this.data.series.forEach(
        function(series, seriesIndex) {
          ...
          var biPol = seriesIndex - (this.data.series.length - 1) / 2,
            ...
            periodHalfLength =
              chartRect[labelAxis.units.len]() /
              normalizedData[seriesIndex].length /
              2;
          ...
          normalizedData[seriesIndex].forEach(
            function(value, valueIndex) {
              ...
              projected[labelAxis.units.pos] += options.stackBars
                ? 0
                : biPol *
    ...
    function createChart(options) {
      ...
      for (var i = 0; i < this.data.series.length; i++) {
        ...
        var pathElement = seriesGroups[i].elem(
          ...
          options.classNames.slice +
            (options.donut ? " " + options.classNames.donut : "")
        );
        ...
        if (options.showLabel) {
          ...
          var labelElement = seriesGroups[i]
            .elem(
              "text",
              {
                dx: labelPosition.x,
