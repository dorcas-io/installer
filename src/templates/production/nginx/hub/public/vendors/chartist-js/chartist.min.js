...
!(function(a, b) {
  ...
  return (
      ...
      (c.noop = function(a) {
        ...
        (c.extend = function(a) {
          ...
          return (
            b.forEach(function(b) {
              for (var d in b)
                a[d] =
                  "object" != typeof b[d] || b[d] instanceof Array
                    ? b[d]
                    : c.extend({}, a[d], b[d]);
            }),
            a
        ...
        (c.getDataArray = function(a, b) {
          ...
          for (var g = 0; g < a.series.length; g++) {
            (e =
              "object" == typeof a.series[g] && void 0 !== a.series[g].data
                ? a.series[g].data
                : a.series[g]),
              e instanceof Array
                ? ((f[g] = []), Array.prototype.push.apply(f[g], e))
                : (f[g] = e);
            for (var h = 0; h < f[g].length; h++)
              (d = f[g][h]),
                (d = 0 === d.value ? 0 : d.value || d),
                (f[g][h] = +d);
          }
          return f;
        }),
        ...
        (c.normalizeDataArray = function(a, b) {
          for (var c = 0; c < a.length; c++)
            if (a[c].length !== b)
              for (var d = a[c].length; b > d; d++) a[c][d] = 0;
          return a;
        }),
        ...
        (c.getHighLow = function(a) {
          var b,
            c,
            d = { high: -Number.MAX_VALUE, low: Number.MAX_VALUE };
        ...
        (c.getBounds = function(a, b, d, e) {
          ...
          i.high === i.low &&
            (0 === i.low
              ...
              : (i.low = 0)),
            (e || 0 === e) &&
              ((i.high = Math.max(e, i.high)), (i.low = Math.min(e, i.low))),
            (i.valueRange = i.high - i.low),
            (i.oom = c.orderOfMagnitude(i.valueRange)),
            (i.min =
              Math.floor(i.low / Math.pow(10, i.oom)) * Math.pow(10, i.oom)),
            (i.max =
              Math.ceil(i.high / Math.pow(10, i.oom)) * Math.pow(10, i.oom)),
            (i.range = i.max - i.min),
            (i.step = Math.pow(10, i.oom)),
            (i.numberOfSteps = Math.round(i.range / i.step));
          for (var j = c.projectLength(a, i.step, i), k = d > j; ; )
            if (k && c.projectLength(a, i.step, i) <= d) i.step *= 2;
            else {
            ...
            (l[k] || 0 === l[k]) &&
              ...
              j.showLabel &&
                c.createLabel(
                  ...
                  a.labelOffset,
                  f,
                  [h.classNames.label, h.classNames[a.units.dir]],
                  g,
                  i
                ));
          });
    ...
    (function(a, b, c) {
      ...
      (c.Interpolation = {}),
        (c.Interpolation.none = function() {
          return function(a) {
            for (
              var b = new c.Svg.Path().move(a[0], a[1]), d = 3;
              d < a.length;
              d += 2
            )
              b.line(a[d - 1], a[d]);
        ...
        (c.Interpolation.simple = function(a) {
          ...
          return function(a) {
            for (
              var b = new c.Svg.Path().move(a[0], a[1]), e = 2;
              e < a.length;
              e += 2
            ) {
              var f = a[e - 2],
        ...
        (c.Interpolation.cardinal = function(a) {
          ...
          return function(a) {
            ...
            for (
              var b, f = new c.Svg.Path().move(a[0], a[1]), g = 0, h = a.length;
              h - 2 * !b > g;
              g += 2
            ) {
              var i = [
              ...
              b
                ...
                : g || (i[0] = { x: +a[g], y: +a[g + 1] }),
                f.curve(
                  (d * (-i[0].x + 6 * i[1].x + i[2].x)) / 6 + e * i[2].x,
                  (d * (-i[0].y + 6 * i[1].y + i[2].y)) / 6 + e * i[2].y,
                  (d * (i[1].x + 6 * i[2].x - i[3].x)) / 6 + e * i[2].x,
                  (d * (i[1].y + 6 * i[2].y - i[3].y)) / 6 + e * i[2].y,
                  i[2].x,
                  i[2].y
                );
            }
    ...
    (function(a, b, c) {
      ...
      function d(a, d, e, f, g) {
        a instanceof SVGElement
          ? (this._node = a)
          : ((this._node = b.createElementNS(y, a)),
            "svg" === a &&
              this._node.setAttributeNS(z, c.xmlNs.qualifiedName, c.xmlNs.uri),
            d && this.attr(d),
            e && this.addClass(e),
            f &&
    ...
    (function(a, b, c) {
      ...
      function d(a, b, d, e, f) {
        d.splice(
          e,
          0,
          c.extend({ command: f ? a.toLowerCase() : a.toUpperCase() }, b)
        );
      }
      function e(a, b) {
      ...
      function n() {
        ...
        return (
          this.pathElements.reduce(
            function(b, c) {
              var d = s[c.command.toLowerCase()].map(
                function(b) {
      ...
      function r() {
        ...
        return (
          (a.pos = this.pos),
          (a.pathElements = this.pathElements.slice().map(function(a) {
            return c.extend({}, a);
          })),
          (a.options = c.extend({}, this.options)),
          a
        );
      }
      var s = {
    ...
    (function(a, b, c) {
      "use strict";
      function d(a, b, d, e, f) {
        c.LinearScaleAxis["super"].constructor.call(this, a, b, d, e, f),
      ...
      function e(a) {
        return {
          pos:
            (this.axisLength * (a - this.bounds.min)) /
    ...
    (function(a, b, c) {
      "use strict";
      function d(a, b, d, e, f) {
        c.StepAxis["super"].constructor.call(this, a, b, d, e, f),
          (this.stepLength =
            this.axisLength / (f.stepCount - (f.stretch ? 1 : 0)));
      }
      function e(a, b) {
    ...
    (function(a, b, c) {
      ...
      function d(a) {
        ...
        var g = c.createChartRect(this.svg, a, f.padding),
          h = c.getHighLow(d);
        (h.high = +a.high || (0 === a.high ? 0 : h.high)),
          (h.low = +a.low || (0 === a.low ? 0 : h.low));
        var i = new c.StepAxis(
            c.Axis.units.x,
            g,
            function(a) {
        ...
        c.createAxis(
          ...
          this.data.series.forEach(
            function(e, f) {
              (b[f] = this.svg.elem("g")),
                b[f].attr(
                  { "series-name": e.name, meta: c.serialize(e.meta) },
                  c.xmlNs.uri
                ),
                b[f].addClass(
                  [
                    a.classNames.series,
                    e.className ||
                      a.classNames.series + "-" + c.alphaNumerate(f)
                  ].join(" ")
                );
              var h = [];
              if (
                  ...
                  function(k, l) {
                    ...
                    if ((h.push(m.x, m.y), a.showPoint)) {
                      var n = b[f]
                        .elem(
                          "line",
                          { x1: m.x, y1: m.y, x2: m.x + 0.01, y2: m.y },
                          a.classNames.point
                        )
                        .attr(
                          { value: k, meta: c.getMetaData(e, l) },
                          c.xmlNs.uri
                        );
                ...
                a.showLine || a.showArea)
              ) {
                var k =
                    "function" == typeof a.lineSmooth
                      ? a.lineSmooth
                      : a.lineSmooth
                ...
                if (a.showLine) {
                  var m = b[f]
                    .elem("path", { d: l.stringify() }, a.classNames.line, !0)
                    .attr({ values: d[f] }, c.xmlNs.uri);
                  this.eventEmitter.emit("draw", {
                    type: "line",
                    values: d[f],
                    path: l.clone(),
                ...
                if (a.showArea) {
                  var n = Math.max(
                      Math.min(a.areaBase, j.bounds.max),
                      j.bounds.min
                    ),
                  ...
                  p.position(0)
                    ...
                    .move(g.x1, o)
                    .line(h[0], h[1])
                    .position(p.pathElements.length)
                    .line(h[h.length - 2], o);
                  var q = b[f]
                    .elem("path", { d: p.stringify() }, a.classNames.area, !0)
                    .attr({ values: d[f] }, c.xmlNs.uri);
                  this.eventEmitter.emit("draw", {
                    type: "area",
                    values: d[f],
      ...
      function d(a) {
        ...
        a.horizontalBars
          ? ((j = l = new c.StepAxis(
              ...
              { stepCount: this.data.labels.length, stretch: a.fullHeight }
            )),
            (i = k = new c.LinearScaleAxis(
              c.Axis.units.x,
              m,
              function(a) {
            ...
            (i = l = new c.LinearScaleAxis(
              ...
              },
              {
                x:
                  ...
                  (this.supportsForeignObject ? -10 : 0),
                y:
                  a.axisY.labelOffset.y + (this.supportsForeignObject ? -15 : 0)
              },
              {
                highLow: b,
        ...
        var n = this.svg.elem("g").addClass(a.classNames.labelGroup),
          ...
          p = a.horizontalBars
            ? m.x1 + i.projectValue(0).pos
            : m.y1 - i.projectValue(0).pos,
          q = [];
        c.createAxis(
          j,
          this.data.labels,
                  ...
                  function(k, l) {
                    var n,
                      ...
                      r = {
                        x:
                          m.x1 +
                          (a.horizontalBars ? i : j).projectValue(k, l, e[f])
                            .pos,
                        y:
                          m.y1 -
                          (a.horizontalBars ? j : i).projectValue(k, l, e[f])
                            .pos
                      };
                    (r[j.units.pos] += h * (a.horizontalBars ? -1 : 1)),
                      (r[j.units.pos] += a.stackBars
                        ? 0
                        : g *
                          a.seriesBarDistance *
                          (a.horizontalBars ? -1 : 1)),
                      (o = q[l] || p),
                      (q[l] = o - (p - r[j.counterUnits.pos]));
                    var s = {};
                    (s[j.units.pos + "1"] = r[j.units.pos]),
                      (s[j.units.pos + "2"] = r[j.units.pos]),
                      (s[j.counterUnits.pos + "1"] = a.stackBars ? o : p),
                      (s[j.counterUnits.pos + "2"] = a.stackBars
                        ? q[l]
                        : r[j.counterUnits.pos]),
                      (n = d[f]
                        .elem("line", s, a.classNames.bar)
                        .attr(
                          { value: k, meta: c.getMetaData(b, l) },
                          c.xmlNs.uri
                        )),
        ...
        for (
          ...
          (i[n] = this.svg.elem("g", null, null, !0)),
            ...
            i[n].addClass(
              [
                a.classNames.series,
                this.data.series[n].className ||
                  a.classNames.series + "-" + c.alphaNumerate(n)
              ].join(" ")
            );
          var o = j + (k[n] / h) * 360;
          o - j === 360 && (o -= 0.01);
          var p = c.polarToCartesian(l.x, l.y, e, j - (0 === n || m ? 0 : 0.2)),
            q = c.polarToCartesian(l.x, l.y, e, o),
            r = new c.Svg.Path(!a.donut)
              .move(q.x, q.y)
              .arc(e, e, 0, o - j > 180, 0, p.x, p.y);
          ...
          if (
            (s.attr({ value: k[n] }, c.xmlNs.uri),
            a.donut &&
              s.attr({ style: "stroke-width: " + +a.donutWidth + "px" }),
            this.eventEmitter.emit("draw", {
              type: "slice",
              value: k[n],
              totalDataSum: h,
