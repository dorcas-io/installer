  ...
  IonRangeSlider.prototype = {
    ...
    pointerUp: function(e) {
      ...
      var is_function =
        ...
        is_original =
          $.contains(this.$cache.cont[0], e.target) || this.dragging;
    ...
    calc: function(update) {
      ...
      switch (this.target) {
        ...
        case "single":
          ...
          this.coords.p_single = this.toFixed(
            (this.coords.p_single_real / 100) * real_width
          );
        ...
        case "from":
          ...
          this.coords.p_from = this.toFixed(
            (this.coords.p_from_real / 100) * real_width
          );
        ...
        case "to":
          ...
          this.coords.p_to = this.toFixed(
            (this.coords.p_to_real / 100) * real_width
          );
    ...
    calcLabels: function() {
      ...
      if (this.options.type === "single") {
        ...
        this.labels.p_to_left =
          this.coords.p_to + this.coords.p_handle / 2 - this.labels.p_to / 2;
        ...
        this.labels.p_single = (this.labels.w_single / this.coords.w_rs) * 100;
        this.labels.p_single_left =
          (this.labels.p_from_left + this.labels.p_to_left + this.labels.p_to) /
            2 -
          this.labels.p_single / 2;
