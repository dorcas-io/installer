!(function() {
  ...
  function c(b, c, d, e, f, g, h, i, j, k, l, m) {
    ...
    return (
      g && (m = g(m)),
      !("number" != typeof m || !isFinite(m)) &&
        (b && 0 === parseFloat(m.toFixed(b)) && (m = 0),
        0 > m && ((n = !0), (m = Math.abs(m))),
        b && ((g = Math.pow(10, b)), (m = (Math.round(m * g) / g).toFixed(b))),
        (m = m.toString()),
        -1 !== m.indexOf(".") &&
          ((b = m.split(".")), (m = b[0]), d && (l = d + b[1])),
        c && ((m = a(m).match(/.{1,3}/g)), (m = a(m.join(a(c))))),
        n && i && (o += i),
        e && (o += e),
        n && j && (o += j),
        (o = o + m + l),
  ...
  function d(a, b, c, d, e, f, g, h, i, j, k, l) {
    ...
    return (
      ...
      !(!l || "string" != typeof l) &&
        (h &&
          l.substring(0, h.length) === h &&
          ((l = l.replace(h, "")), (m = !0)),
        d && l.substring(0, d.length) === d && (l = l.replace(d, "")),
        i &&
          l.substring(0, i.length) === i &&
          ((l = l.replace(i, "")), (m = !0)),
        e && l.slice(-1 * e.length) === e && (l = l.slice(0, -1 * e.length)),
        b && (l = l.split(b).join("")),
        c && (l = l.replace(c, ".")),
        m && (a += "-"),
        (a = Number((a + l).replace(/[^0-9\.\-.]/g, ""))),
        g && (a = g(a)),
        !("number" != typeof a || !isFinite(a)) && a)
    );
  }
  function e(a) {
    var c,
    ...
    for (c = 0; c < h.length; c += 1)
      (d = h[c]),
        ...
        void 0 === e
          ? (f[d] =
              "negative" !== d || f.negativeBefore
                ? "mark" === d && "." !== f.thousand && "."
                : "-")
          : "decimals" === d
          ? 0 < e && 8 > e && (f[d] = e)
          : "encoder" === d || "decoder" === d || "edit" === d || "undo" === d
          ? "function" == typeof e && (f[d] = e)
  ...
  (function(a) {
    ...
    function T(a, b) {
      ...
      void 0 === b.tooltips && (b.tooltips = !0);
      var c = R(b, a),
        d = S(a, c, b);
