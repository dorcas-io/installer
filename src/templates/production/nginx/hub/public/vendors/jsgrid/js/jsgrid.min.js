  ...
  (d.prototype = {
    ...
    _createHeaderRow: function() {
      ...
      return (
        this._eachField(function(c, d) {
          var e = b("<th>")
            .addClass(c.headercss || c.css)
            .appendTo(a)
            .append(c.headerTemplate ? c.headerTemplate() : "")
            .css("width", c.width);
          this.sorting &&
            c.sorting &&
    ...
    _createFilterRow: function() {
      ...
      return (
        this._eachField(function(c) {
          b("<td>")
            .addClass(c.filtercss || c.css)
            .appendTo(a)
            .append(c.filterTemplate ? c.filterTemplate() : "")
            .width(c.width);
        }),
        a
      );
    ...
    _createInsertRow: function() {
      ...
      return (
        this._eachField(function(c) {
          b("<td>")
            .addClass(c.insertcss || c.css)
            .appendTo(a)
            .append(c.insertTemplate ? c.insertTemplate() : "")
            .width(c.width);
        }),
        a
      );
    ...
    _createNoDataContent: function() {
      return b.isFunction(this.noDataRenderer)
        ? this.noDataRenderer()
        : this.noDataText;
    },
    ...
    _createCell: function(a, c) {
      ...
      return (
        (d = b.isFunction(c.cellRenderer)
          ? b(c.cellRenderer(e, a))
          : b("<td>").append(c.itemTemplate ? c.itemTemplate(e, a) : e)),
    ...
    insertItem: function(a) {
      var b = a || this._getInsertItem(),
        c = this._callEventHandler(this.onItemInserting, { item: b });
    ...
    _createEditRow: function(a) {
      ...
      return (
        this._eachField(function(d) {
          b("<td>")
            .addClass(d.editcss || d.css)
            .appendTo(c)
            .append(d.editTemplate ? d.editTemplate(a[d.name], a) : "")
            .width(d.width || "auto");
        }),
        c
      );
  ...
  (function(a, b, c) {
    function d(a) {
      (this.items = []),
        ...
        a.valueField &&
          a.items.length &&
          (this.valueType = typeof a.items[0][a.valueField]),
