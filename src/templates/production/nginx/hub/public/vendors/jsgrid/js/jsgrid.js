  ...
  Grid.prototype = {
    ...
    _createFilterRow: function() {
      ...
      this._eachField(function(field) {
        $("<td>")
          .addClass(field.filtercss || field.css)
          .appendTo($result)
    ...
    _createInsertRow: function() {
      ...
      this._eachField(function(field) {
        $("<td>")
          .addClass(field.insertcss || field.css)
          .appendTo($result)
    ...
    _createCell: function(item, field) {
      ...
      if ($.isFunction(field.cellRenderer)) {
        ...
        $result = $("<td>").append(
          field.itemTemplate ? field.itemTemplate(fieldValue, item) : fieldValue
        );
      }
    ...
    loadData: function(filter) {
      ...
      return this._controllerCall("loadData", filter, args.cancel, function(
        loadedData
      ) {
    ...
    _createEditRow: function(item) {
      ...
      this._eachField(function(field) {
        $("<td>")
          .addClass(field.editcss || field.css)
          .appendTo($result)
          .append(
            field.editTemplate ? field.editTemplate(item[field.name], item) : ""
          )
...
(function(jsGrid, $, undefined) {
  ...
  ControlField.prototype = new Field({
    ...
    _createModeSwitchButton: function() {
      ...
      var $button = this._createGridButton(this.modeButtonClass, "", function(
        grid
      ) {
