...
!(function(a) {
          ...
          var g = {},
            ...
            k = function(b, c) {
              a(c).each(function(c, d) {
                a(b).val(d.text), (g[d.field] = d.text);
              });
            };
  ...
  var k = a.fn.bootstrapTable.Constructor,
    l = k.prototype.init,
    m = k.prototype.initTable,
    n = k.prototype.initServer,
    o = k.prototype.onSort,
    p = k.prototype.onPageNumber,
    q = k.prototype.onPageListChange,
    r = k.prototype.onPageFirst,
    s = k.prototype.onPagePre,
    t = k.prototype.onPageNext,
    u = k.prototype.onPageLast,
    v = k.prototype.toggleColumn,
    w = k.prototype.selectPage,
    x = k.prototype.onSearch;
  (k.prototype.init = function() {
    if (
      ...
      this.$el
        ...
        .on("post-body.bs.table", j(a));
    }
    l.apply(this, Array.prototype.slice.apply(arguments));
  }),
    (k.prototype.initServer = function() {
      var c = this,
        d = [],
        e = function(a) {
          return a.filterControl && "select" === a.filterControl;
        },
        f = function(a) {
          return a.filterData && "column" !== a.filterData;
        },
        g = function() {
          var a = JSON.parse(h(c, c.options.cookieIdTable, b.filterControl));
          return c.options.cookie && a;
        };
      (d = a.grep(c.columns, function(a) {
        return e(a) && !f(a);
      })),
        (k.prototype.initServer = n),
        (this.options.filterControl && g() && 0 === d.length) ||
          n.apply(this, Array.prototype.slice.apply(arguments));
    }),
    (k.prototype.initTable = function() {
      m.apply(this, Array.prototype.slice.apply(arguments)), this.initCookie();
    }),
    (k.prototype.initCookie = function() {
    ...
    (k.prototype.selectPage = function(a) {
      w.apply(this, Array.prototype.slice.apply(arguments)),
        g(this, b.pageNumber, a);
    }),
    (k.prototype.onSearch = function() {
      var c = Array.prototype.slice.apply(arguments);
      x.apply(this, c),
        a(c[0].currentTarget)
          .parent()
          .hasClass("search") && g(this, b.searchText, this.searchText);
    }),
    (k.prototype.getCookies = function() {
      var c = this,
        d = {};
      return (
    ...
    (k.prototype.deleteCookie = function(a) {
