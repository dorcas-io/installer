...
!(function(a) {
  ...
  var b = a.fn.bootstrapTable.utils.sprintf,
    ...
    m = function(b, c) {
      a.fn.bootstrapTable.utils.isIEBrowser() &&
        (void 0 !== b.setSelectionRange
    ...
    q = function(b) {
      ...
      a.each(b.header.fields, function(k, l) {
        var m =
            b.columns[a.fn.bootstrapTable.utils.getFieldIndex(b.columns, l)],
                  ...
                  d
                    ...
                    .on("changeDate", function(c) {
                      a(
                        b(
                          ".%s",
                          c.currentTarget.classList
                            .toString()
                            .split(" ")
                            .join(".")
                        )
                      ).val(c.currentTarget.value),
