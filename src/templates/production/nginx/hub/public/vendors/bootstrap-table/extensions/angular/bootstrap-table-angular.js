  ...
  angular
    ...
    .directive("bsTableControl", [
      ...
      function(uiBsTables) {
        ...
        $(document)
          .on("post-header.bs.table", CONTAINER_SELECTOR + " table", function(
            evt
          ) {
          ...
          .on("sort.bs.table", CONTAINER_SELECTOR + " table", function(
            evt,
            sortName,
            sortOrder
          ) {
          ...
          .on("page-change.bs.table", CONTAINER_SELECTOR + " table", function(
            evt,
            pageNumber,
            pageSize
          ) {
          ...
          .on("search.bs.table", CONTAINER_SELECTOR + " table", function(
            evt,
            searchText
          ) {
            var bsTable = getBsTable(evt.target);
