    ...
    if (
      ...
      f.length ||
        ...
        f.click(function() {
          ...
          function c(b, c) {
            for (var d = "<table><thead><tr>", e = 0; e < c.length; e++)
              c[e].printIgnore || (d += "<th>" + c[e].title + "</th>");
            d += "</tr></thead><tbody>";
            for (var f = 0; f < b.length; f++) {
              d += "<tr>";
              for (var g = 0; g < c.length; g++)
                c[g].printIgnore || (d += "<td>" + a(b[f], f, c[g]) + "</td>");
              d += "</tr>";
            }
          ...
          var h = function(a) {
            (a = f(a, g(b.options.columns))),
              (a = d(a, b.options.printSortColumn, b.options.printSortOrder));
            var e = c(a, b.options.columns[0]),
              h = window.open("");
            h.document.write(b.options.printPageBuilder.call(this, e)),
              h.print(),
              h.close();
          };
          h(
