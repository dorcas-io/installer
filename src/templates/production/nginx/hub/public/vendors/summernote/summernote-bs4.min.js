...
!(function(t, e) {
  ...
  var e = (function() {
    ...
    m = o('<div class="modal" aria-hidden="false" tabindex="-1"/>', function(
      t,
      e
    ) {
    ...
    v = o('<label class="custom-control custom-checkbox"></label>', function(
      t,
      e
    ) {
      ...
      button: function(t, e) {
        return o(
          ...
          function(t, e) {
            e &&
              e.tooltip &&
              t.attr({ title: e.tooltip }).tooltip({
                container: e.container,
                trigger: "hover",
                placement: "bottom"
              });
