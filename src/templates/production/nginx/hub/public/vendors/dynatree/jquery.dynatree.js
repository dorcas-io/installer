  ...
  DynaTreeNode.prototype = {
    ...
    getEventTargetType: function(event) {
      ...
      if (tcn.indexOf(cns.title) >= 0) {
        ...
        tcn.indexOf(cns.checkbox) >= 0 ||
        tcn.indexOf(cns.radio) >= 0
      ) {
        return "checkbox";
      } else if (tcn.indexOf(cns.nodeIcon) >= 0) {
        return "icon";
      } else if (
        tcn.indexOf(cns.empty) >= 0 ||
    ...
    _updatePartSelectionState: function() {
      ...
      if (!this.hasChildren()) {
        sel =
          this.bSelected && !this.data.unselectable && !this.data.isStatusNode;
...
*/
    ...
    _onDragEvent: function(eventName, node, otherNode, event, ui, draggable) {
      ...
      switch (eventName) {
        ...
        case "enter":
          r = dnd.onDragEnter
            ? dnd.onDragEnter(node, otherNode, ui, draggable)
            : null;
          if (!r) {
        ...
        revert:
          dnd.revert !== true
            ...
            : function(dropped) {
                ...
                var isRejected =
                  helper && helper.hasClass("dynatree-drop-reject");
                return isRejected;
              },
