  ...
  methods: {
    edit: function() {
      ...
      Swal.fire({
        ...
        preConfirm: result => {
          return axios
            .put("/mcu/customers-custom-fields/" + context.record_id, {
              name: result
            })
    ...
    deleteField: function(event) {
      ...
      Swal.fire({
        title: "Are you sure?",
        text:
          "You are about to delete the custom field (" + this.field_name + ").",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: "#DD6B55",
        ...
        preConfirm: delete_custom => {
          return axios
            .delete("/mcu/customers-custom-fields/" + id)
            .then(function(response) {
              console.log(response);
    ...
    deleteField: function() {
      ...
      Swal.fire({
        ...
        preConfirm: delete_field_credential => {
          return axios
            .delete("/mpp/credentials/" + context.credential.id)
            .then(function(response) {
              //console.log(response);
    ...
    deleteField: function() {
      ...
      Swal.fire({
        ...
        preConfirm: delete_field_experience => {
          return axios
            .delete("/mpp/experiences/" + context.experience.id)
            .then(function(response) {
              //console.log(response);
    ...
    deleteField: function() {
      ...
      Swal.fire({
        ...
        preConfirm: delete_field_service => {
          return axios
            .delete("/mpp/services/" + context.service.id)
            .then(function(response) {
              //console.log(response);
    ...
    accept: function() {
      ...
      Swal.fire({
        ...
        preConfirm: service_accept => {
          return axios
            .put("/mps/service-requests/" + context.request.id, {
              status: "accepted"
            })
            .then(function(response) {
              console.log(response);
  ...
  methods: {
    subscribePlan: function() {
      ...
      Swal.fire({
        title: "Switch Plan",
        text:
          "Would you like to subscribe to the " + this.display_name + " plan?",
        type: "warning",
        showCancelButton: true,
        ...
        preConfirm: subscribe_plan => {
          ...
          let item = {
            ...
            variable_name: "hub_subscription",
          ...
          axios
            .post("/mse/settings-subscription-switch", {
              plan: context.profile.name,
              expiry_date: context.expiry_date
            })
            .then(function(response) {
              if (purchase_amount > 0) {
                assistantVue.showPaystackDialog(
                  purchase_amount,
                  item,
                  "/mse/settings-subscription?subscription_successful__" +
                    context.index
                );
              } else {
                window.location =
  ...
  methods: {
    edit: function() {
      ...
      Swal.fire({
        ...
        preConfirm: value => {
          return axios
            .put("/msl/sales-categories/" + context.category.id, {
              name: value,
              update_slug: true
            })
            .then(function(response) {
    ...
    deleteField: function() {
      ...
      Swal.fire({
        ...
        preConfirm: value => {
          return axios
            .delete("/msl/sales-categories/" + context.category.id)
            .then(function(response) {
              console.log(response);
              context.$emit("remove", context.index);
              return swal(
  ...
  methods: {
    updateSetting: function(event) {
      ...
      if (!target.hasAttribute("data-name")) {
        target = target.parentNode.hasAttribute("data-name")
          ? target.parentNode
          : target;
      }
      ...
      axios
        ...
        .then(function(response) {
          ...
          swal(
            "Done",
            "The " + title + " setting was successfully saved.",
            "success"
          );
