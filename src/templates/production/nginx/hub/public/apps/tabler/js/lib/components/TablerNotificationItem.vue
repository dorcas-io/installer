...
export default {
  ...
  mounted: function() {
    if (
      typeof this.notification.actor_photo !== "undefined" &&
      this.notification.actor_photo !== null
    ) {
      this.styles.actor["background-image"] =
        "url(" + this.notifications.actor_photo + ")";
    }
