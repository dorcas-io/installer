(function(e, t) {
  ...
  function n(e) {
    ...
    if (
      (e.titleText
        ? (d.innerText = e.titleText)
        : e.title && (d.innerHTML = e.title.split("\n").join("<br />")),
      "string" == typeof e.backdrop
        ? (M().style.background = e.backdrop)
        : !e.backdrop &&
          L([document.documentElement, document.body], k["no-backdrop"]),
      e.html ? oe(e.html, u) : e.text ? ((u.textContent = e.text), T(u)) : V(u),
      e.position in k
        ? L(l, k[e.position])
    ...
    if (
      (e.imageUrl
        ? (P.setAttribute("src", e.imageUrl),
          ...
          T(P),
          e.imageWidth
            ? P.setAttribute("width", e.imageWidth)
            : P.removeAttribute("width"),
          e.imageHeight
            ? P.setAttribute("height", e.imageHeight)
            : P.removeAttribute("height"),
          (P.className = k.image),
          e.imageClass && L(P, e.imageClass))
        : V(P),
      ...
      L([p, g], k.styled),
        e.confirmButtonColor &&
          (p.style.backgroundColor = e.confirmButtonColor),
