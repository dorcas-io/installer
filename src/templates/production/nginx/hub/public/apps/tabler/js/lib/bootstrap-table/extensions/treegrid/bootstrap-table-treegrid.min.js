    ...
    for (var j = i.length - 1, k = 0; j >= k; k++) {
      ...
      (l._level = b._level + 1),
        ...
        (h.options.rowStyle = function(a) {
          var b = a[h.options.idField] ? a[h.options.idField] : 0,
            c = a[h.options.parentIdField] ? a[h.options.parentIdField] : 0;
          return { classes: "treegrid-" + b + " treegrid-parent-" + c };
        }),
    ...
    return g.treeEnable
      ? g.options.onCheckRoot.apply(g, [a, d])
        ? (void 0 === a._level && (a._level = 0),
          (g.options.rowStyle = function(a) {
            var b = a[g.options.idField] ? a[g.options.idField] : 0;
            return { classes: "treegrid-" + b };
          }),
          e.apply(g, [a, b, d, f]),
          !0)
        : !1
