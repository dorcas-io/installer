  ...
  steps: [
    {
      ...
      content:
        "Hello there!<br>My name is Dorcas and I will be taking you on a tour of Hub. Its really easy to use once you try one or 2 actions on your own. Before that, let me quickly show you around. Click Next to begin",
      placement: "top",
      xOffset: "0",
      arrowOffset: "10",
      width: "500"
    },
    {
      ...
      content:
        "The Customers Module contains management tools to create, edit, categorize and group your esteemed customers",
      placement: "bottom"
    },
    {
      ...
      content:
        "The eCommerce menu comes with tools to manage domain names, email accounts, build websites, blogs and setup online stores",
      placement: "bottom"
    },
    {
      ...
      title: "People Module",
      content:
        "The People menu allows you to manage your employees&apos; data and organize them using departments and teams",
      placement: "bottom"
    },
    {
      ...
      content:
        "The Finance Module contains tools and interfaces for adding, importing and categorizing your accounting entries",
      placement: "bottom"
    },
    {
      ...
      title: "Sales Module",
      content:
        "The Sales menu contains several tools to add, edit and categorize your products as well as invoicing and order management",
      placement: "bottom"
    },
    {
      ...
      title: "Addons",
      content:
        "The Addons menu contains powerful items such as the Library, Marketplace, Integrations and App Store features",
      placement: "bottom"
    },
    {
      ...
      content:
        "The Settings menu contains several settings that allow you to customize several aspects of your experience with the Hub",
      placement: "bottom"
    },
    {
      ...
      title: "Profile",
      content:
        "Here you can make changes to your profile, access the account Setup &amp; Overview and Logout of the Hub",
      placement: "bottom"
    },
    {
      ...
      title: "Assistant",
      content:
        "From any page of the Hub, click the Help button to bring up a helpful video(s), documentation and an option to contact the support team",
      placement: "bottom"
    },
    {
      target: "welcome-area",
      ...
      content:
        "That&apos;s it in a nutshell :-)<br>You can proceed to the Dashboard or any other modules to take an action<br>Best of Luck",
      placement: "top",
      xOffset: "0",
      arrowOffset: "10",
      width: "500"
