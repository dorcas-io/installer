                      ...
                      for (var A in x)
                        if ("element" !== A) {
                          ...
                          if (((_.currentValue = O), "tween" === A)) m = O;
                            ...
                            var V = k.setPropertyValue(
                              T,
                              A,
                              _.currentValue +
                                (0 === parseFloat(O) ? "" : _.unitType),
                              _.rootPropertyValue,
                              _.scrollData
                            );
            ...
            if (!(7 >= h)) {
              ...
              var x = function() {
                      ...
                      for (var _ in M)
                        if ("element" !== _) {
                          ...
                          (M[_].startValue = M[_].currentValue = M[_].endValue),
                            (M[_].endValue = E),
                            v.isEmptyObject(y) || (M[_].easing = s.easing),
                            b.debug &&
                              console.log(
                      ...
                      for (var V in m) {
                        ...
                        if (
                          ...
                          ((s.display !== n &&
                            ...
                            0 !== z &&
                            (L = 0),
                            s._cacheValues && M && M[V]
                              ? (L === n && (L = M[V].endValue + M[V].unitType),
                                ($ = r(a).rootPropertyValueCache[j]))
                              : k.Hooks.registered[V]
                              ? L === n
                                ? (($ = k.getPropertyValue(a, j)),
                                  (L = k.getPropertyValue(a, V, $)))
                                : ($ = k.Hooks.templates[j][1])
                              : L === n && (L = k.getPropertyValue(a, V));
                          var N,
                            W,
                            F,
                            Q = !1;
                ...
                if (
                                  ...
                                  n === o &&
                                    ...
                                    "stop" === m
                                      ? (r(n) &&
                                          r(n).tweensContainer &&
                                          !1 !== a &&
                                          p.each(r(n).tweensContainer, function(
                                            t,
                                            e
                                          ) {
                          ...
                          return (
                            ...
                            p.each(f, function(t, e) {
                              parseFloat(q.stagger)
                                ? (q.delay = E + parseFloat(q.stagger) * t)
                                : v.isFunction(q.stagger) &&
                                  (q.delay = E + q.stagger.call(e, t, C)),
                                q.drag &&
                                  ((q.duration =
                                    parseFloat(_) ||
                  ...
                  if (
                    ((q.loop = parseInt(q.loop)), (V = 2 * q.loop - 1), q.loop)
                  )
                    for (var z = 0; V > z; z++) {
                      var H = { delay: q.delay, progress: q.progress };
                      z === V - 1 &&
                        ((H.display = q.display),
                        (H.visibility = q.visibility),
                        (H.complete = q.complete)),
                        x(f, "reverse", H);
                    }
                  return t();
                }
...
(Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity),
  ...
  (function(t) {
    ...
    (i._toasts = []),
      (i._container = null),
      (i._draggedToast = null),
      (window.Materialize.Toast = i),
      (window.Materialize.toast = function(t, e, n, o) {
  ...
  (function() {
    ...
    function n(n, r) {
        ...
        if (!e || !(u < y - w || u > y + w)) {
          ...
          _.setHand(l, c, !e, !0),
            ...
            s.off(f).on(f, function(t) {
              ...
              (e || p) && n === l && u === c && _.setHand(n, u),
                "hours" === _.currentView
                  ? _.toggleView("minutes", x / 2)
                  : r.autoclose &&
      ...
      (this.id = i("cp")),
          ...
          (r.ampmclickable
            ? (this.spanAmPm.empty(),
              ...
              a('<div id="click-pm">PM</div>')
                ...
                .appendTo(this.spanAmPm))
            : (this.spanAmPm.empty(),
              a('<div id="click-am">AM</div>').appendTo(this.spanAmPm),
              a('<div id="click-pm">PM</div>').appendTo(this.spanAmPm))),
        a(
        ...
        A.on("focus.clockpicker click.clockpicker", a.proxy(this.show, this));
      var E,
        M,
        I,
        D,
        V = a('<div class="clockpicker-tick"></div>');
      if (r.twelvehour)
        for (E = 1; E < 13; E += 1)
          (M = V.clone()),
            (I = (E / 6) * Math.PI),
      ...
      if (
        ...
        var q = u.find(".clockpicker-canvas"),
          z = t("svg");
        z.setAttribute("class", "clockpicker-svg"),
          z.setAttribute("width", k),
          z.setAttribute("height", k);
        var H = t("g");
