...
!(function(e, i) {
  ...
  return (
    ...
    (i.prototype.checkFileSize = function() {
      return 0 === this.maxFileSizeToByte() ||
    ...
    (i.prototype.maxFileSizeToByte = function() {
      ...
      if (0 !== this.settings.maxFileSize) {
        var i = this.settings.maxFileSize.slice(-1).toUpperCase(),
          ...
          r = 1024 * s;
        "K" === i
          ? (e = parseFloat(this.settings.maxFileSize) * t)
          : "M" === i
          ? (e = parseFloat(this.settings.maxFileSize) * s)
          : "G" === i && (e = parseFloat(this.settings.maxFileSize) * r);
      }
      return e;
    }),
    (e.fn[t] = function(s) {
      return (
        this.each(function() {
          e.data(this, "plugin_" + t) ||
            e.data(this, "plugin_" + t, new i(this, s));
        }),
        this
      );
    }),
