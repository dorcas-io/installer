...
DROP TABLE IF EXISTS `hub_companies`;
...
DROP TABLE IF EXISTS `hub_failed_jobs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hub_failed_jobs` (
...
DROP TABLE IF EXISTS `hub_migrations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `hub_password_resets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hub_password_resets` (
...
DROP TABLE IF EXISTS `hub_tax_authorities`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hub_tax_authorities` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `hub_users` (
  ...
  CONSTRAINT `users_company_foreign_key` FOREIGN KEY (`company_id`) REFERENCES `hub_companies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
