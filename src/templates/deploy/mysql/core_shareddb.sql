...
INSERT INTO `countries` (`id`, `uuid`, `name`, `iso_code`, `dialing_code`, `deleted_at`, `updated_at`, `created_at`)
VALUES
...
INSERT INTO `states` (`id`, `uuid`, `country_id`, `name`, `iso_code`, `deleted_at`, `updated_at`, `created_at`)
VALUES
